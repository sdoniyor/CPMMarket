...
export default function FaqPage() {
  ...
  return (
    <div
      className="min-h-screen text-white px-4 pb-24 pt-28 flex flex-col items-center"
      style={{ background: "#080809" }}
    >
      {/* NAVBAR */}
      <Navbar />
      ...
      <div className="relative z-10 w-full max-w-2xl">
        ...
        <motion.button
          ...
          animate={{ opacity: 1, x: 0 }}
          onClick={() => navigate("/market")}
          className="flex items-center gap-2 mb-10 font-black uppercase tracking-[0.22em]"
          style={{ fontSize: 9, color: "rgba(255,255,255,0.25)" }}
          onMouseEnter={(e) =>
            ((e.currentTarget as HTMLButtonElement).style.color = "#FF3D00")
          }
          onMouseLeave={(e) =>
        ...
        >
          ...
          >
            FAQ <span style={{ color: "#FF3D00" }}>///</span>
          </h1>

          <p
            className="font-bold uppercase tracking-[0.25em] mt-3"
              ...
              >
                <div
                  ...
                  style={{
                    background: isOpen ? "#FF3D000C" : "#0D0D0F",
                    border: `1px solid ${
                      isOpen ? "#FF3D0045" : "rgba(255,255,255,0.07)"
                    }`,
                    borderRadius: 2,
                  }}
                >
                  ...
                  <div className="flex justify-between items-center px-5 py-4">
                    <div className="flex items-center gap-3">
                      <span
                        ...
                        style={{
                          fontSize: 11,
                          color: isOpen ? "#FF3D00" : "rgba(255,255,255,0.2)",
                        }}
                      >
                        {String(i + 1).padStart(2, "0")}
                      </span>
                    ...
                    <div
                      ...
                      style={{
                        ...
                        border: `1px solid ${
                          isOpen ? "#FF3D0050" : "rgba(255,255,255,0.08)"
                        }`,
                      }}
                    >
                      {isOpen ? (
                        <Minus size={12} style={{ color: "#FF3D00" }} />
                      ) : (
                  ...
                  <AnimatePresence>
                    {isOpen && (
                      <motion.div
                        ...
                        className="overflow-hidden"
                      >
                        <div className="px-5 pb-5 pt-1 border-t border-white/5 flex gap-3">
                          <span>{item.icon}</span>
        ...
        {/* FOOTER */}
        <div className="mt-12 p-5 bg-[#0D0D0F] border border-white/10 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <MessageSquare size={14} style={{ color: "#FF3D00" }} />
            <div>
              <p className="text-xs font-bold">Не нашли ответ?</p>
              <p className="text-[10px] text-white/40">Напишите в поддержку</p>
            </div>
          </div>

          <button className="px-5 py-3 bg-[#FF3D00] text-black font-bold text-xs uppercase">
            Чат
          </button>
        </div>

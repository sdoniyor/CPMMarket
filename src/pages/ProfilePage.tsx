      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
            ...
            <div className="relative group">
              <div className="w-32 h-32 md:w-44 md:h-44 rounded-[2.5rem] overflow-hidden bg-white/5 border-2 border-white/10 p-1 group-hover:border-yellow-400 transition-all duration-500 shadow-2xl">
                {avatarUrl ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center text-6xl font-black text-white/5 uppercase">
                    {user.name?.[0]}
                  </div>
                )}
              </div>
            ...
            <div className="text-center md:text-left flex-1 space-y-3">
              <h1 className="text-4xl md:text-6xl font-[1000] italic uppercase tracking-tighter leading-[0.8]">
                {user.name}
              </h1>
            ...
            <div className="grid grid-cols-1 gap-2 min-w-[120px]">
              <div className="bg-white/5 border border-white/5 p-4 rounded-[2rem] text-center">
                <div className="text-white/20 text-[10px] font-black uppercase tracking-widest mb-1">
                  Referrals
                </div>
          ...
          >
            ...
            <div className="relative group">
              <input
                value={refLink}
                readOnly
                className="w-full bg-black/40 border border-white/10 rounded-2xl p-4 pr-14 text-sm font-medium text-white/30 focus:outline-none"
              />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
            <div className="flex items-center gap-5 text-center md:text-left flex-col md:flex-row">
              ...
              <div>
                ...
                <p className="text-white/30 text-[10px] font-bold uppercase tracking-[0.2em] mt-1">
                  {user.telegram_id
                    ? `Linked: @${user.telegram_username}`
                    : "Sync for exclusive car parts"}
                </p>
              </div>
            </div>
            ...
            {user.telegram_id ? (
              ...
              <button
                onClick={() =>
                  window.open(
                    `https://t.me/CPMMarket_bot?start=${token}`,
                    "_blank"
                  )
                }
                className="w-full md:w-auto bg-[#0088cc] text-white px-10 py-4 rounded-2xl font-black uppercase text-[10px] tracking-[0.2em] hover:brightness-110 transition-all shadow-lg shadow-[#0088cc]/20 active:translate-y-1"
